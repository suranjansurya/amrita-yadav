...
export function Section19AmritaSerendipity() {
  return (
      ...
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center">
        ...
        <MotionWrapper type="fadeInUp">
          ...
          <p className="font-body text-sm sm:text-base text-pink-800/80 max-w-md mx-auto mb-8">
            The two glowing paths orbit around her 3D portrait in the dream space.
          </p>
        </MotionWrapper>
        ...
        <MotionWrapper delay={0.8} type="fadeIn">
          <div className="mt-8 flex items-center space-x-2 text-pink-700 font-script text-3xl">
            ...
            <span>Where paths meet and memories stay.</span>
          </div>
        </MotionWrapper>
