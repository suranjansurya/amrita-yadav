...
import { ConnectionParticles3D } from '../3d/ConnectionParticles3D';
import { MotionWrapper } from '../animations/MotionWrapper';
import { GlassCard } from '../common/GlassCard';
import { Sparkles } from 'lucide-react';

export function Section09OurConnection() {
    ...
    >
      <div className="max-w-4xl mx-auto w-full flex flex-col items-center">
        ...
        <MotionWrapper type="fadeInUp">
          ...
          <h2 className="font-heading font-bold text-4xl sm:text-6xl text-pink-950 mb-6">
            The Orbit of Two Souls
          </h2>
        </MotionWrapper>

        {/* 3D Dual Particle Orbiting Connection View */}
        <MotionWrapper delay={0.4} type="scaleUp" className="my-6">
          <ConnectionParticles3D scrollProgress={scrollProgress} />
        </MotionWrapper>
        ...
        <div className="space-y-6 max-w-2xl mx-auto w-full">
          ...
          {/* Blooming Lotus Symbol Ending */}
          <MotionWrapper delay={1.8} type="fadeIn">
            <div className="pt-8 flex flex-col items-center">
              <span className="text-5xl animate-pulse-glow mb-3 select-none">🪷</span>
              <p className="font-script text-3xl text-pink-700">
                Created with care for Amrita Yadav
              </p>
            </div>
          </MotionWrapper>
        </div>
